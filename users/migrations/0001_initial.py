    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('departement', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='DemandeMateriel.departement')),
                ('filial', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='DemandeMateriel.filial')),
        ...
        migrations.CreateModel(
            name='Chauffeur',
            fields=[
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, related_name='Chauffeur', serialize=False, to=settings.AUTH_USER_MODEL)),
